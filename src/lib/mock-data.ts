...
export const products: Product[] = [
  {
    id: "p1",
    slug: "sovereign-whey",
    name: "Sovereign Whey Isolate",
    tagline: "30g protein. Zero compromise.",
    description: "Cold-filtered isolate engineered for elite recovery. Naija-sourced flavor profile, lab-verified macros.",
    priceNGN: 48000,
  ...
  },
  {
    ...
    name: "Tactical Resistance Kit",
    tagline: "Full-body system. Travel-ready.",
    description: "Five-tier resistance bands, anchored door mount, gold-thread carry case.",
    priceNGN: 72000,
  ...
  },
  {
    ...
    name: "Ignition Protocol — 8 Week",
    tagline: "Strength + cut sequence.",
    description: "Periodized program with weekly check-ins, Naija meal swaps, and elite operator chat access.",
    priceNGN: 35000,
    commissionPct: 30,
    category: "program",
    badge: "BESTSELLER",
  ...
  },
  {
    ...
    name: "Midnight Elite Stack",
    tagline: "Sleep • Recovery • Hormones.",
    description: "Tri-phase nightly protocol: magnesium glycinate, ashwagandha KSM-66, zinc bisglycinate.",
    priceNGN: 54000,
  ...
  },
  {
    ...
    name: "The Sovereign Playbook",
    tagline: "Digital field manual.",
    description: "240-page PDF + audio companion on physical sovereignty, fasting protocols, and Naija superfoods.",
    priceNGN: 18000,
    commissionPct: 40,
    category: "digital",
    badge: "DIGITAL",
  ...
  },
  {
    id: "p6",
    slug: "command-shaker",
    name: "Command Shaker 750ml",
    tagline: "Insulated. Engraved. Yours.",
    description: "Vacuum-sealed stainless steel with mixing lattice and individually engraved operator ID.",
    priceNGN: 22000,
    commissionPct: 15,
    category: "gear",
