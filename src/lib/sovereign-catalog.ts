...
export const SOVEREIGN_CATALOG: SovereignSKU[] = [
  ...
  },
  {
    ...
    name: "ResoFlex Station Gym Equipment",
    tagline: "Home gym command deck.",
    tier: 5,
    priceNGN: 420_000,
    intents: ["muscle", "fat-loss", "wellness"],
    description: "ResoFlex Station — multi-function home gym equipment. Adjustable resistance, compact footprint, engineered for daily strength + hypertrophy work.",
    badge: "EQUIPMENT",
  },
  {
    ...
    description: "Commander + Kinetic + Meal & Move + Heritage Meal rolled into one deploy. Best-value bundle — surfaced as the primary premium offer.",
    badge: "TIER 5 · BUNDLE",
