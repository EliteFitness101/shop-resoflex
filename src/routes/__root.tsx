...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ResoFlex Shop— Branded Fitness Fashion" },
      ...
      { property: "og:title", content: "ResoFlex Shop— Branded Fitness Fashion" },
      ...
      { name: "twitter:title", content: "ResoFlex Shop— Branded Fitness Fashion" },
